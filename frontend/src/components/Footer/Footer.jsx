...
function Footer({ isStart, isFinal, keyboardClick, goBack }) {
    ...
    return (
        <footer className={`${Style.footer} `}>
            ...
            <button onClick={goBack} type='button' className={`${Style.footer__button} `}>{buttonText}</button>
            {!isFinal && <container onClick={keyboardClick} type='button' className={Style.container}>
